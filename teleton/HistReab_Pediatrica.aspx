<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HistReab_Pediatrica.aspx.cs" 
Inherits="HistReab_Pediatrica" ValidateRequest="false"%>
   ...
   <!-- TinyMCE -->
    ...
    <div id="content">
        <div id="navcenter">
            <div id="titulo">
                <h1>
                    Historia Clinica De Rehabilitación Pediátrica
                    <br />
                    <br />
                </h1>
            </div>
            <div>
                <fieldset>
                    <ul class="list">
                        <li class="list">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                        <asp:Label ID="lb_Expediente" runat="server" Text="No. de Expediente:" Font-Size="Medium"></asp:Label>
                            &nbsp;&nbsp;
                        ...
                        <asp:Label ID="lb_Edad" runat="server" Text="Edad:" Visible="false" Font-Size="Medium"></asp:Label>
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lb_Informante" runat="server" Text="Informante/Confiabilidad:" Font-Size="Medium"></asp:Label>
                            &nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                            ...
                            <asp:Button ID="btn_Nuevo" runat="server" CssClass="boton" Text="Nuevo"
                                OnClick="btn_Nuevo_Click" Enabled="False" Visible="False" />
