<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HistoPacienteAltaAreas.aspx.cs" Inherits="HistoPacienteAltaAreas" %>
               ...
               <asp:GridView ID="GridViewAreas"  runat="server" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Area">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="Label1" runat="server" Text='<%# Eval("area1")!=null ? "<a style=\"color:black;\" href=\"HistoPacienteFrameAltaAreas.aspx?id=" + ((string)Eval("area1")).Substring(0, ((string)Eval("area1")).IndexOf(" ")) + "\" target=\"hitopaciente_frame_alta_areas\">" + ((string)Eval("area1")).Substring(((string)Eval("area1")).IndexOf(" ")+1, ((string)Eval("area1")).Length - ((string)Eval("area1")).IndexOf(" ")-1) + "</a>" : "" %>'></asp:LinkButton>
                                        </ItemTemplate>
